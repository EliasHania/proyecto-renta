// src/wizard/Paso1.jsx
import { useState } from "react";

const Paso1 = ({ onNext, onFileUpload }) => {
  ...
  return (
    <div className="bg-white p-6 rounded shadow-md max-w-2xl mx-auto">
      <h2 className="text-xl font-bold mb-4">Paso 1: Historial de Futuros</h2>
      <p className="text-sm text-gray-600 mb-4">
        Arrastra y suelta el archivo CSV o XLSX con tu historial de operaciones
        de futuros.
      </p>
      ...
      >
        {archivo ? (
          ...
          <p className="text-gray-500">
            Arrastra el archivo aquí o suéltalo para comenzar
          </p>
        )}
      </div>
