// src/wizard/Paso4.jsx
import { useState } from "react";

const Paso4 = ({ onNext, onFileUpload }) => {
  ...
  return (
    <div className="bg-white p-6 rounded shadow-md max-w-2xl mx-auto">
      <h2 className="text-xl font-bold mb-4">
        Paso 4: Recompensas (staking, airdrops, mining)
      </h2>
      <p className="text-sm text-gray-600 mb-4">
        Sube aquí el archivo con tus ingresos por staking, airdrops u otras
        recompensas obtenidas durante el año fiscal.
      </p>
