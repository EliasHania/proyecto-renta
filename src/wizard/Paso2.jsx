// src/wizard/Paso2.jsx
import { useState } from "react";

const Paso2 = ({ onNext, onFileUpload }) => {
  ...
  return (
    <div className="bg-white p-6 rounded shadow-md max-w-2xl mx-auto">
      <h2 className="text-xl font-bold mb-4">
        Paso 2: Historial de Futuros Estándar
      </h2>
      <p className="text-sm text-gray-600 mb-4">
        Sube el archivo CSV o XLSX con el historial de futuros estándar de tu
        exchange.
      </p>
      ...
      >
        {archivo ? (
          ...
          <p className="text-gray-500">
            Arrastra el archivo aquí o suéltalo para continuar
          </p>
        )}
      </div>
